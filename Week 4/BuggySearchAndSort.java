 ...
 */
	...
	public static void selectionSort(int[] array) {
		for (int top = array.length - 1; top > 0; top--) {
			...
			int temp = array[top];  // swap top item with the biggest item
...
/*
The following problems was solved
1: import java.util.* instead of java.util.Arrays.
2. In "contains" method should remove the "else" part otherwise it will exist on the
first number which is not equal to 5.
3. In "bubbleSort" method, in the second loop should be "j++" instead of "i++".
4. In "selectionSort" method, in the first "if" statement it should be "i" instead of "1".
5. In "insertionSort" method. IN the while it should be "pos >= 0" instead of "pos>0".
6. In "insertionSort" method, in the last line, should be "array[pos+1]" instead of "array[pos]".  
 */
